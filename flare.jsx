(function() {
	app.beginUndoGroup("Create Flare");
	...
	para_layer.name         = "Flare";
	para_layer.blendingMode = BlendingMode.SCREEN;
	...
	m_fill.name = "fill";
	m_fill.property("ADBE Vector Fill Color").setValue([0,0,0]);

	var effects_group = para_layer("Effects");
	effects_group.addProperty("ADBE Fill")("Color").setValue([1,1,1]);
